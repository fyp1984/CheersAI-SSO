...
class AccountAvatar extends React.Component {
  render() {
    ...
    const normalizedSrc = Setting.normalizeUrl(src) || "/logo.png";
    ...
    if (size !== undefined) {
      return (
        <img width={size} height={size} src={normalizedSrc} onError={(e) => {
      ...
      return (
        <img height={height} src={normalizedSrc} onError={(e) => {
          e.currentTarget.onerror = null;
          e.currentTarget.src = "/logo.png";
        }} />
      );
      ...
      return (
        <img width={width} src={normalizedSrc} onError={(e) => {
          e.currentTarget.onerror = null;
          e.currentTarget.src = "/logo.png";
        }} />
      );
