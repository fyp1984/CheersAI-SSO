...
function ManagementPage(props) {
  ...
  function getMenuItems() {
    ...
    if (Setting.isLocalAdminUser(props.account) && Conf.ShowGithubCorner) {
      res.push(Setting.getItem(<a href={"https://cheersai.com"}>
        <span style={{fontWeight: "bold", backgroundColor: "rgba(59,130,246,0.4)", marginTop: "12px", paddingLeft: "5px", paddingRight: "5px", display: "flex", alignItems: "center", height: "40px", borderRadius: "5px"}}>
          📚 CheersAI Documentation 📖
        </span>
      </a>, "#"));
    }
