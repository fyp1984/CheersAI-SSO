          ...
          <Row>
            ...
            <Col span={12}>
              ...
              <Card id="about-card" title={i18next.t("system:About Casdoor")} bordered={true} style={{textAlign: "center"}}>
                ...
                Product: CheersAI-SSO
                <br />
                {i18next.t("system:Version")}: {versionText}
                <br />
                {i18next.t("system:Official website")}: <a target="_blank" rel="noreferrer" href={window.location.origin}>{window.location.origin}</a>
                <br />
                {i18next.t("system:Community")}: <a target="_blank" rel="noreferrer" href={window.location.origin}>CheersAI-SSO</a>
              </Card>
            </Col>
            <Col span={6}></Col>
          </Row>
